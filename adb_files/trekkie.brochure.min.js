(function outer(g,f,a){function b(a){if(f[a])return f[a].exports;if(g[a])return e(a,b);throw Error('cannot find module "'+a+'"');}function e(b,d){var e=f[b]={exports:{}},h=g[b],v=h[2],h=h[0],r=!0;try{h.call(e.exports,function(a){return d(g[b][1][a]||a)},e,e.exports,outer,g,f,a),r=!1}finally{r?delete f[b]:v&&(f[v]=f[b])}return f[b].exports}var d=function(){return this}(),h;for(h in a)a[h]?d[a[h]]=b(h):b(h);b.duo=!0;b.cache=f;b.modules=g;return b})({1:[function(c,g,f){f=window.analytics||[];var a=c("segmentio/analytics.js-core"),
...
new L(l));this.emit("track",a,b,d);this._callback(e);return this};a.prototype.trackClick=a.prototype.trackLink=function(a,b,d){if(!a)return this;p.element(a)&&(a=[a]);var e=this;r(a,function(a){if(!p.element(a))throw new TypeError("Must pass HTMLElement to `analytics.trackLink`.");n(a,"click",function(h){var l=p.fn(b)?b(a):b,c=p.fn(d)?d(a):d,k=a.getAttribute("href")||a.getAttributeNS("http://www.w3.org/1999/xlink","href")||a.getAttribute("xlink:href");e.track(l,c);k&&"_blank"!==a.target&&!w(h)&&(D(h),
e._callback(function(){window.location.href=k}))})});return this};a.prototype.trackSubmit=a.prototype.trackForm=function(a,b,d){if(!a)return this;p.element(a)&&(a=[a]);var e=this;r(a,function(a){function h(l){D(l);l=p.fn(b)?b(a):b;var c=p.fn(d)?d(a):d;e.track(l,c);e._callback(function(){a.submit()})}if(!p.element(a))throw new TypeError("Must pass HTMLElement to `analytics.trackForm`.");var l=window.jQuery||window.Zepto;l?l(a).submit(h):n(a,"submit",h)});return this};a.prototype.page=function(a,b,
...
'"':'"'+a+'"'}function e(a,d){var c,h,f,k,g=m,q,n=d[a];n&&"object"===typeof n&&"function"===typeof n.toJSON&&(n=n.toJSON(a));"function"===typeof v&&(n=v.call(d,a,n));switch(typeof n){case "string":return b(n);case "number":return isFinite(n)?String(n):"null";case "boolean":case "null":return String(n);case "object":if(!n)return"null";m+=l;q=[];if("[object Array]"===Object.prototype.toString.apply(n)){k=n.length;for(c=0;c<k;c+=1)q[c]=e(c,n)||"null";f=0===q.length?"[]":m?"[\n"+m+q.join(",\n"+m)+"\n"+
g+"]":"["+q.join(",")+"]";m=g;return f}if(v&&"object"===typeof v)for(k=v.length,c=0;c<k;c+=1)"string"===typeof v[c]&&(h=v[c],(f=e(h,n))&&q.push(b(h)+(m?": ":":")+f));else for(h in n)Object.prototype.hasOwnProperty.call(n,h)&&(f=e(h,n))&&q.push(b(h)+(m?": ":":")+f);f=0===q.length?"{}":m?"{\n"+m+q.join(",\n"+m)+"\n"+g+"}":"{"+q.join(",")+"}";m=g;return f}}var d=g.exports={};"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+
...
59:[function(c,g,f){function a(a){var b=f.cookie;a=f.levels(a);for(var c=0;c<a.length;++c){var k=a[c],g={domain:"."+k};b("__tld__",1,g);if(b("__tld__"))return b("__tld__",null,g),k}return""}var b=c("url").parse;c=c("cookie");f=g.exports=a;f.cookie=c;a.levels=function(a){a=b(a).hostname.split(".");var d=a[a.length-1],c=[];if(4==a.length&&parseInt(d,10)==d||1>=a.length)return c;for(d=a.length-2;0<=d;--d)c.push(a.slice(d).join("."));return c}},{url:63,cookie:64}],63:[function(c,g,f){f.parse=function(a){var b=
...
main:"analytics.js",dependencies:{},devDependencies:{}}},{}],3:[function(c,g,f){g.exports={"google-analytics":c("analytics.js-integration-google-analytics"),"trekkie-xtld":c("../trekkie/integration/trekkie-xtld.js"),multitrack:c("../trekkie/integration/multitrack.js"),optimizely:c("../trekkie/integration/optimizely.js"),performance:c("../trekkie/integration/performance.js")}},{"analytics.js-integration-google-analytics":79,"../trekkie/integration/trekkie-xtld.js":80,"../trekkie/integration/multitrack.js":81,
"../trekkie/integration/optimizely.js":82,"../trekkie/integration/performance.js":83}],79:[function(c,g,f){function a(a,b){if(a){var d=a.path;b.includeSearch&&a.search&&(d+=a.search);return d}}function b(a){return!a||0>a?0:Math.round(a)}function e(a,b){var d={};r([b.metrics,b.dimensions,b.contentGroupings],function(b){r(b,function(b,e){var c=v(a,b)||a[b];t.boolean(c)&&(c=c.toString());c&&(d[e]=c)})});return d}function d(a){var b=a.properties(),b={id:a.sku()||a.id(),name:a.name(),category:a.category(),
quantity:a.quantity(),price:a.price(),brand:b.brand,variant:b.variant,currency:a.currency()};if(a=a.proxy("properties.coupon"))b.coupon=a;window.ga("ec:addProduct",b)}function h(a,b,e){d(a);window.ga("ec:setAction",b,e||{})}function k(a){a=z([a.paymentMethod,a.shippingMethod],function(a){return a});return 0<a.length?a.join(", "):null}function m(a,b){b.currency=b.currency||a.currency();return new l({properties:b})}var l=c("facade").Track,q=c("defaults"),v=c("obj-case"),r=c("each"),u=c("analytics.js-integration"),
t=c("is"),p=c("object").length,w=c("global-queue")("_gaq"),z=c("select"),x=c("use-https"),A;g.exports=f=function(a){a.addIntegration(n);A=a.user()};var n=f.Integration=u("Google Analytics").readyOnLoad().global("ga").global("gaplugins").global("_gaq").global("GoogleAnalyticsObject").option("anonymizeIp",!1).option("classic",!1).option("contentGroupings",{}).option("dimensions",{}).option("domain","auto").option("doubleClick",!1).option("enhancedEcommerce",!1).option("enhancedLinkAttribution",!1).option("ignoredReferrers",
...
n.on("construct",function(a){a.options.classic?(a.initialize=a.initializeClassic,a.loaded=a.loadedClassic,a.page=a.pageClassic,a.track=a.trackClassic,a.completedOrder=a.completedOrderClassic):a.options.enhancedEcommerce&&(a.viewedProduct=a.viewedProductEnhanced,a.clickedProduct=a.clickedProductEnhanced,a.addedProduct=a.addedProductEnhanced,a.removedProduct=a.removedProductEnhanced,a.startedOrder=a.startedOrderEnhanced,a.viewedCheckoutStep=a.viewedCheckoutStepEnhanced,a.completedCheckoutStep=a.completedCheckoutStepEnhanced,
a.updatedOrder=a.updatedOrderEnhanced,a.completedOrder=a.completedOrderEnhanced,a.refundedOrder=a.refundedOrderEnhanced,a.viewedPromotion=a.viewedPromotionEnhanced,a.clickedPromotion=a.clickedPromotionEnhanced)});n.prototype.initialize=function(){this.pageCalled=!1;var a=this.options;window.GoogleAnalyticsObject="ga";window.ga=window.ga||function(){window.ga.q=window.ga.q||[];window.ga.q.push(arguments)};window.ga.l=(new Date).getTime();"localhost"===window.location.hostname&&(a.domain="none");window.ga("create",
a.trackingId,{cookieDomain:a.domain||n.prototype.defaults.domain,siteSpeedSampleRate:a.siteSpeedSampleRate,sampleRate:a.sampleRate,allowLinker:!0});a.doubleClick&&window.ga("require","displayfeatures");a.enhancedLinkAttribution&&window.ga("require","linkid","linkid.js");a.sendUserId&&A.id()&&window.ga("set","userId",A.id());a.anonymizeIp&&window.ga("set","anonymizeIp",!0);a=e(A.traits(),a);p(a)&&window.ga("set",a);this.load("library",this.ready)};n.prototype.loaded=function(){return!!window.gaplugins};
n.prototype.page=function(b){var d=b.category(),c=b.properties(),f=b.fullName(),h=this.options,g=b.proxy("context.campaign")||{},k={},m=a(c,this.options),l=f||c.title,q=b.referrer()||"";this._category=d;k.page=m;k.title=l;k.location=c.url;g.name&&(k.campaignName=g.name);g.source&&(k.campaignSource=g.source);g.medium&&(k.campaignMedium=g.medium);g.content&&(k.campaignContent=g.content);g.term&&(k.campaignKeyword=g.term);c=e(c,h);p(c)&&window.ga("set",c);m={page:m,title:l};q!==document.referrer&&(m.referrer=
q);window.ga("set",m);this.pageCalled&&delete k.location;window.ga("send","pageview",k);d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));f&&this.options.trackNamedPages&&(d=b.track(f),this.track(d,{nonInteraction:1}));this.pageCalled=!0};n.prototype.identify=function(a){var b=this.options;b.sendUserId&&a.userId()&&window.ga("set","userId",a.userId());a=e(A.traits(),b);p(a)&&window.ga("set",a)};n.prototype.track=function(a,d){var c=a.options(this.name),f=this.options,
h=q(d||{},c),h=q(h,f),g=a.properties(),c=a.proxy("context.campaign")||{},f=e(g,f);p(f)&&window.ga("set",f);f={eventAction:a.event(),eventCategory:a.category()||this._category||"All",eventLabel:g.label,eventValue:b(g.value||a.revenue()),nonInteraction:!(!g.nonInteraction&&!h.nonInteraction)};c.name&&(f.campaignName=c.name);c.source&&(f.campaignSource=c.source);c.medium&&(f.campaignMedium=c.medium);c.content&&(f.campaignContent=c.content);c.term&&(f.campaignKeyword=c.term);window.ga("send","event",
f)};n.prototype.completedOrder=function(a){var b=a.total()||a.revenue()||0,d=a.orderId(),e=a.products(),c=a.properties();d&&(this.ecommerce||(window.ga("require","ecommerce"),this.ecommerce=!0),window.ga("ecommerce:addTransaction",{affiliation:c.affiliation,shipping:a.shipping(),revenue:b,tax:a.tax(),id:d,currency:a.currency()}),r(e,function(b){b=m(a,b);window.ga("ecommerce:addItem",{category:b.category(),quantity:b.quantity(),price:b.price(),name:b.name(),sku:b.sku()||b.id(),id:d,currency:b.currency()})}),
window.ga("ecommerce:send"))};n.prototype.initializeClassic=function(){var a=this.options,b=a.anonymizeIp,d=a.domain,e=a.enhancedLinkAttribution,c=a.ignoredReferrers,f=a.siteSpeedSampleRate;window._gaq=window._gaq||[];w("_setAccount",a.trackingId);w("_setAllowLinker",!0);b&&w("_gat._anonymizeIp");d&&w("_setDomainName",d);f&&w("_setSiteSpeedSampleRate",f);e&&w("_require","inpage_linkid",("https:"===document.location.protocol?"https:":"http:")+"//www.google-analytics.com/plugins/ga/inpage_linkid.js");
c&&(t.array(c)||(c=[c]),r(c,function(a){w("_addIgnoredRef",a)}));this.options.doubleClick?this.load("double click",this.ready):(a=x()?"https":"http",this.load(a,this.ready))};n.prototype.loadedClassic=function(){return!(!window._gaq||window._gaq.push===Array.prototype.push)};n.prototype.pageClassic=function(b){var d=b.category(),e=b.properties(),c=b.fullName();w("_trackPageview",a(e,this.options));d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));c&&this.options.trackNamedPages&&
(d=b.track(c),this.track(d,{nonInteraction:1}))};n.prototype.trackClassic=function(a,d){var e=d||a.options(this.name),c=a.properties(),f=a.revenue(),h=a.event(),g=this._category||a.category()||"All",k=c.label,f=b(f||c.value);w("_trackEvent",g,h,k,f,!(!c.nonInteraction&&!e.nonInteraction))};n.prototype.completedOrderClassic=function(a){var b=a.total()||a.revenue()||0,d=a.orderId(),e=a.products()||[],c=a.properties(),f=a.currency();d&&(w("_addTrans",d,c.affiliation,b,a.tax(),a.shipping(),a.city(),a.state(),
a.country()),r(e,function(a){a=new l({properties:a});w("_addItem",d,a.sku()||a.id(),a.name(),a.category(),a.price(),a.quantity())}),w("_set","currencyCode",f),w("_trackTrans"))};n.prototype.loadEnhancedEcommerce=function(a){this.enhancedEcommerceLoaded||(window.ga("require","ec"),this.enhancedEcommerceLoaded=!0);window.ga("set","&cu",a.currency())};n.prototype.pushEnhancedEcommerce=function(a){a=z(["send","event",a.category()||"EnhancedEcommerce",a.event()||"Action not defined",a.properties().label,
{nonInteraction:1}],function(a){return void 0!==a});window.ga.apply(window,a)};n.prototype.startedOrderEnhanced=function(a){this.viewedCheckoutStep(a)};n.prototype.updatedOrderEnhanced=function(a){this.startedOrderEnhanced(a)};n.prototype.viewedCheckoutStepEnhanced=function(a){var b=a.products(),e=a.properties(),c=k(e);this.loadEnhancedEcommerce(a);r(b,function(b){b=m(a,b);d(b)});window.ga("ec:setAction","checkout",{step:e.step||1,option:c||void 0});this.pushEnhancedEcommerce(a)};n.prototype.completedCheckoutStepEnhanced=
function(a){var b=a.properties(),d=k(b);b.step&&d&&(this.loadEnhancedEcommerce(a),window.ga("ec:setAction","checkout_option",{step:b.step||1,option:d}),window.ga("send","event","Checkout","Option"))};n.prototype.completedOrderEnhanced=function(a){var b=a.total()||a.revenue()||0,e=a.orderId(),c=a.products(),f=a.properties();e&&(this.loadEnhancedEcommerce(a),r(c,function(b){b=m(a,b);d(b)}),window.ga("ec:setAction","purchase",{id:e,affiliation:f.affiliation,revenue:b,tax:a.tax(),shipping:a.shipping(),
coupon:a.coupon()}),this.pushEnhancedEcommerce(a))};n.prototype.refundedOrderEnhanced=function(a){var b=a.orderId(),d=a.products();b&&(this.loadEnhancedEcommerce(a),r(d,function(a){a=new l({properties:a});window.ga("ec:addProduct",{id:a.sku()||a.id(),quantity:a.quantity()})}),window.ga("ec:setAction","refund",{id:b}),this.pushEnhancedEcommerce(a))};n.prototype.addedProductEnhanced=function(a){this.loadEnhancedEcommerce(a);h(a,"add");this.pushEnhancedEcommerce(a)};n.prototype.removedProductEnhanced=
function(a){this.loadEnhancedEcommerce(a);h(a,"remove");this.pushEnhancedEcommerce(a)};n.prototype.viewedProductEnhanced=function(a){var b=a.properties(),d={};this.loadEnhancedEcommerce(a);b.list&&(d.list=b.list);h(a,"detail",d);this.pushEnhancedEcommerce(a)};n.prototype.clickedProductEnhanced=function(a){var b=a.properties(),d={};this.loadEnhancedEcommerce(a);b.list&&(d.list=b.list);h(a,"click",d);this.pushEnhancedEcommerce(a)};n.prototype.viewedPromotionEnhanced=function(a){var b=a.properties();
this.loadEnhancedEcommerce(a);window.ga("ec:addPromo",{id:a.id(),name:a.name(),creative:b.creative,position:b.position});this.pushEnhancedEcommerce(a)};n.prototype.clickedPromotionEnhanced=function(a){var b=a.properties();this.loadEnhancedEcommerce(a);window.ga("ec:addPromo",{id:a.id(),name:a.name(),creative:b.creative,position:b.position});window.ga("ec:setAction","promo_click",{});this.pushEnhancedEcommerce(a)}},{facade:8,defaults:84,"obj-case":42,each:4,"analytics.js-integration":85,is:18,object:20,
"global-queue":86,select:87,"use-https":88}],84:[function(c,g,f){g.exports=function(a,b){for(var e in b)e in a||(a[e]=b[e]);return a}},{}],85:[function(c,g,f){var a=c("bind"),b=c("clone"),e=c("debug"),d=c("defaults"),h=c("extend"),k=c("slug"),m=c("./protos"),l=c("./statics");g.exports=function(c){function f(h){if(h&&h.addIntegration)return h.addIntegration(f);this.debug=e("analytics:integration:"+k(c));this.options=d(b(h)||{},this.defaults);this._queue=[];this.once("ready",a(this,this.flush));f.emit("construct",
this);this.ready=a(this,this.ready);this._wrapInitialize();this._wrapPage();this._wrapTrack()}f.prototype.defaults={};f.prototype.globals=[];f.prototype.templates={};f.prototype.name=c;h(f,l);h(f.prototype,m);return f}},{bind:55,clone:12,debug:89,defaults:15,extend:90,slug:91,"./protos":92,"./statics":93}],89:[function(c,g,f){g.exports="undefined"==typeof window?c("./lib/debug"):c("./debug")},{"./lib/debug":94,"./debug":95}],94:[function(c,g,f){c=c("tty");g.exports=function(c){function f(){}function g(a){a=
a instanceof Error?a.stack||a.message:a;var b=new Date,e=b-(d[c]||b);d[c]=b;b="  \u001b[9"+u+"m"+c+" \u001b[3"+u+"m\u001b[90m"+a+"\u001b[3"+u+"m +";e=36E5<=e?(e/36E5).toFixed(1)+"h":6E4<=e?(e/6E4).toFixed(1)+"m":1E3<=e?(e/1E3|0)+"s":e+"ms";a=b+e+"\u001b[0m";console.error.apply(this,arguments)}function v(a){a=a instanceof Error?a.stack||a.message:a;a=(new Date).toUTCString()+" "+c+" "+a;console.error.apply(this,arguments)}f.enabled=!1;var r=b.some(function(a){return a.test(c)});if(r)return f;r=a.some(function(a){return a.test(c)});
if(!r)return f;var u=e[h++%e.length];g.enabled=v.enabled=!0;return k||process.env.DEBUG_COLORS?g:v};var a=[],b=[];(process.env.DEBUG||"").split(/[\s,]+/).forEach(function(d){d=d.replace("*",".*?");"-"===d[0]?b.push(new RegExp("^"+d.substr(1)+"$")):a.push(new RegExp("^"+d+"$"))});var e=[6,2,3,4,5,1],d={},h=0,k=c.isatty(2)},{}],95:[function(c,g,f){function a(b){return a.enabled(b)?function(e){e instanceof Error&&(e=e.stack||e.message);var d=new Date,c=d-(a[b]||d);a[b]=d;e=b+" "+e+" +"+a.humanize(c);
window.console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)}:function(){}}g.exports=a;a.names=[];a.skips=[];a.enable=function(b){try{localStorage.debug=b}catch(c){}for(var e=(b||"").split(/[\s,]+/),d=e.length,f=0;f<d;f++)b=e[f].replace("*",".*?"),"-"===b[0]?a.skips.push(new RegExp("^"+b.substr(1)+"$")):a.names.push(new RegExp("^"+b+"$"))};a.disable=function(){a.enable("")};a.humanize=function(a){return 36E5<=a?(a/36E5).toFixed(1)+"h":6E4<=a?(a/6E4).toFixed(1)+"m":1E3<=
a?(a/1E3|0)+"s":a+"ms"};a.enabled=function(b){for(var e=0,d=a.skips.length;e<d;e++)if(a.skips[e].test(b))return!1;e=0;for(d=a.names.length;e<d;e++)if(a.names[e].test(b))return!0;return!1};try{window.localStorage&&a.enable(localStorage.debug)}catch(b){}},{}],90:[function(c,g,f){g.exports=function(a){for(var b=Array.prototype.slice.call(arguments,1),e=0,d;d=b[e];e++)if(d)for(var c in d)a[c]=d[c];return a}},{}],91:[function(c,g,f){g.exports=function(a,b){b||(b={});return a.toLowerCase().replace(b.replace||
/[^a-z0-9]/g," ").replace(/^ +| +$/g,"").replace(/ +/g,b.separator||"-")}},{}],92:[function(c,g,f){function a(){}function b(a){return x.array(a)?z(e,a)?"mixed":"array":x.object(a)?"map":"unknown"}function e(a){return x.object(a)&&x.string(a.key)&&A.call(a,"value")?!0:!1}function d(a,b){b=b||function(){};var d=new Image;d.onerror=h(b,"failed to load pixel",d);d.onload=function(){b()};d.src=a.src;d.width=1;d.height=1;return d}function h(a,b,d){return function(e){e=e||window.event;var c=Error(b);c.event=
e;c.source=d;a(c)}}function k(a,b){return r(function(a,d,e){a[e]=d.replace(/\{\{\ *(\w+)\ *\}\}/g,function(a,d){return b[d]});return a},{},a.attrs)}g=c("emitter");var m=c("after"),l=c("each"),q=c("analytics-events"),v=c("fmt"),r=c("foldl"),u=c("load-iframe"),t=c("load-script"),p=c("to-no-case"),w=c("next-tick"),z=c("every"),x=c("is"),A=Object.prototype.hasOwnProperty,n=window.onerror,B=window.setInterval,C=window.setTimeout;g(f);f.initialize=function(){w(this.ready)};f.loaded=function(){return!1};
f.page=function(a){};f.track=function(a){};f.map=function(a,d){var e=p(d),c=b(a);return"unknown"===c?[]:r(function(a,b,d){var f,h;"map"===c&&(f=d,h=b);"array"===c&&(h=f=b);"mixed"===c&&(f=b.key,h=b.value);p(f)===e&&a.push(h);return a},[],a)};f.invoke=function(a){if(this[a]){var b=Array.prototype.slice.call(arguments,1);if(!this._ready)return this.queue(a,b);var d;try{this.debug("%s with %o",a,b),d=this[a].apply(this,b)}catch(e){this.debug("error %o calling %s with %o",e,a,b)}return d}};f.queue=function(a,
b){if("page"===a&&this._assumesPageview&&!this._initialized)return this.page.apply(this,b);this._queue.push({method:a,args:b})};f.flush=function(){this._ready=!0;var a=this;l(this._queue,function(b){a[b.method].apply(a,b.args)});this._queue.length=0};f.reset=function(){for(var a=0;a<this.globals.length;a++)window[this.globals[a]]=void 0;window.setTimeout=C;window.setInterval=B;window.onerror=n;window.onload=null};f.load=function(b,e,c){"function"===typeof b&&(c=b,b=e=null);b&&"object"===typeof b&&
(c=e,e=b,b=null);"function"===typeof e&&(c=e,e=null);b=b||"library";e=e||{};e=this.locals(e);var f=this.templates[b];if(!f)throw Error(v('template "%s" not defined.',b));b=k(f,e);c=c||a;var h=this,g;switch(f.type){case "img":b.width=1;b.height=1;g=d(b,c);break;case "script":g=t(b,function(a){if(!a)return c();h.debug('error loading "%s" error="%s"',h.name,a)});delete b.src;l(b,function(a,b){g.setAttribute(a,b)});break;case "iframe":g=u(b,c)}return g};f.locals=function(a){a=a||{};var b=Math.floor((new Date).getTime()/
36E5);a.hasOwnProperty("cache")||(a.cache=b);l(this.options,function(b,d){a.hasOwnProperty(b)||(a[b]=d)});return a};f.ready=function(){this.emit("ready")};f._wrapInitialize=function(){var a=this.initialize;this.initialize=function(){this.debug("initialize");this._initialized=!0;var b=a.apply(this,arguments);this.emit("initialize");return b};this._assumesPageview&&(this.initialize=m(2,this.initialize))};f._wrapPage=function(){var a=this.page;this.page=function(){return this._assumesPageview&&!this._initialized?
this.initialize.apply(this,arguments):a.apply(this,arguments)}};f._wrapTrack=function(){var a=this.track;this.track=function(b){var d=b.event(),e,c,f;for(f in q)if(A.call(q,f)){var h=q[f];if(this[f]&&h.test(d)){c=this[f].apply(this,arguments);e=!0;break}}e||(c=a.apply(this,arguments));return c}}},{emitter:7,after:9,each:96,"analytics-events":97,fmt:98,foldl:16,"load-iframe":99,"load-script":100,"to-no-case":101,"next-tick":56,every:102,is:103}],96:[function(c,g,f){try{var a=c("type")}catch(d){a=c("component-type")}var b=
c("to-function"),e=Object.prototype.hasOwnProperty;g.exports=function(d,c,f){c=b(c);f=f||this;switch(a(d)){case "array":var g=c;for(c=0;c<d.length;++c)g.call(f,d[c],c);break;case "object":if("number"==typeof d.length){g=c;for(c=0;c<d.length;++c)g.call(f,d[c],c);break}for(g in d)e.call(d,g)&&c.call(f,g,d[g]);break;case "string":for(g=c,c=0;c<d.length;++c)g.call(f,d.charAt(c),c)}}},{type:104,"component-type":104,"to-function":73}],104:[function(c,g,f){var a=Object.prototype.toString;g.exports=function(b){switch(a.call(b)){case "[object Function]":return"function";
case "[object Date]":return"date";case "[object RegExp]":return"regexp";case "[object Arguments]":return"arguments";case "[object Array]":return"array";case "[object String]":return"string"}return null===b?"null":void 0===b?"undefined":b&&1===b.nodeType?"element":b===Object(b)?"object":typeof b}},{}],97:[function(c,g,f){g.exports={removedProduct:/^[ _]?removed[ _]?product[ _]?$/i,viewedProduct:/^[ _]?viewed[ _]?product[ _]?$/i,viewedProductCategory:/^[ _]?viewed[ _]?product[ _]?category[ _]?$/i,addedProduct:/^[ _]?added[ _]?product[ _]?$/i,
...
{}],98:[function(c,g,f){function a(b){var e=[].slice.call(arguments,1),d=0;return b.replace(/%([a-z])/gi,function(b,c){return a[c]?a[c](e[d++]):b+c})}c=window.JSON?JSON.stringify:function(a){return String(a)};g.exports=a;a.o=c;a.s=String;a.d=parseInt},{}],99:[function(c,g,f){var a=c("script-onload"),b=c("next-tick"),e=c("type");g.exports=function(d,c){if(!d)throw Error("Cant load nothing...");"string"==e(d)&&(d={src:d});var f="https:"===document.location.protocol||"chrome-extension:"===document.location.protocol;
d.src&&0===d.src.indexOf("//")&&(d.src=f?"https:"+d.src:"http:"+d.src);f&&d.https?d.src=d.https:!f&&d.http&&(d.src=d.http);var g=document.createElement("iframe");g.src=d.src;g.width=d.width||1;g.height=d.height||1;g.style.display="none";"function"==e(c)&&a(g,c);b(function(){var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(g,a)});return g}},{"script-onload":105,"next-tick":56,type:47}],105:[function(c,g,f){function a(a,b){a.addEventListener("load",function(a,e){b(null,e)},
!1);a.addEventListener("error",function(c){var f=Error('script error "'+a.src+'"');f.event=c;b(f)},!1)}function b(a,b){a.attachEvent("onreadystatechange",function(c){/complete|loaded/.test(a.readyState)&&b(null,c)});a.attachEvent("onerror",function(c){var f=Error('failed to load the script "'+a.src+'"');f.event=c||window.event;b(f)})}g.exports=function(c,d){return c.addEventListener?a(c,d):b(c,d)}},{}],100:[function(c,g,f){var a=c("script-onload"),b=c("next-tick"),e=c("type");g.exports=function(d,
c){if(!d)throw Error("Cant load nothing...");"string"==e(d)&&(d={src:d});var f="https:"===document.location.protocol||"chrome-extension:"===document.location.protocol;d.src&&0===d.src.indexOf("//")&&(d.src=f?"https:"+d.src:"http:"+d.src);f&&d.https?d.src=d.https:!f&&d.http&&(d.src=d.http);var g=document.createElement("script");g.type="text/javascript";g.async=!0;g.src=d.src;"function"==e(c)&&a(g,c);b(function(){var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(g,a)});return g}},
{"script-onload":105,"next-tick":56,type:47}],101:[function(c,g,f){function a(a){return a.replace(h,function(a,b){return b?" "+b:""})}function b(a){return a.replace(k,function(a,b,d){return b+" "+d.toLowerCase().split("").join(" ")})}g.exports=function(c){return e.test(c)?c.toLowerCase():d.test(c)?a(c).toLowerCase():b(c).toLowerCase()};var e=/\s/,d=/[\W_]/,h=/[\W_]+(.|$)/g,k=/(.)([A-Z]+)/g},{}],102:[function(c,g,f){var a;try{a=c("@ndhoule/each")}catch(b){a=c("each")}g.exports=function(b,c){if("function"!==
typeof b)throw new TypeError("`predicate` must be a function but was a "+typeof b);var d=!0;a(function(a,c,e){d=!!b(a,c,e);if(!d)return!1},c);return d}},{each:65}],103:[function(c,g,f){function a(a){return function(d){return a===b(d)}}g=c("is-empty");try{var b=c("type")}catch(h){b=c("component-type")}c="arguments array boolean date element function null number object regexp string undefined".split(" ");for(var e=0,d;d=c[e];e++)f[d]=a(d);f.fn=f["function"];f.empty=g;f.nan=function(a){return f.number(a)&&
a!=a}},{"is-empty":46,type:47,"component-type":47}],93:[function(c,g,f){function a(a){a=a.replace(' src="',' data-src="');var c=b(a),f={};e(c.attributes,function(b){var c="data-src"===b.name?"src":b.name;d(b.name+"=",a)&&(f[c]=b.value)});return{type:c.tagName.toLowerCase(),attrs:f}}g=c("emitter");var b=c("domify"),e=c("each"),d=c("includes");g(f);f.option=function(a,b){this.prototype.defaults[a]=b;return this};f.mapping=function(a){this.option(a,[]);this.prototype[a]=function(b){return this.map(this.options[a],
b)};return this};f.global=function(a){this.prototype.globals.push(a);return this};f.assumesPageview=function(){this.prototype._assumesPageview=!0;return this};f.readyOnLoad=function(){this.prototype._readyOnLoad=!0;return this};f.readyOnInitialize=function(){this.prototype._readyOnInitialize=!0;return this};f.tag=function(b,d){null==d&&(d=b,b="library");this.prototype.templates[b]=a(d);return this}},{emitter:7,domify:106,each:96,includes:71}],106:[function(c,g,f){g.exports=function(b,c){if("string"!=
typeof b)throw new TypeError("String expected");c||(c=document);var d=/<([\w:]+)/.exec(b);if(!d)return c.createTextNode(b);b=b.replace(/^\s+|\s+$/g,"");d=d[1];if("body"==d)return d=c.createElement("html"),d.innerHTML=b,d.removeChild(d.lastChild);var d=a[d]||a._default,f=d[0],g=d[1],m=d[2],d=c.createElement("div");for(d.innerHTML=g+b+m;f--;)d=d.lastChild;if(d.firstChild==d.lastChild)return d.removeChild(d.firstChild);for(f=c.createDocumentFragment();d.firstChild;)f.appendChild(d.removeChild(d.firstChild));
return f};c=document.createElement("div");c.innerHTML='  <link/><table></table><a href="/a">a</a><input type="checkbox"/>';g=!c.getElementsByTagName("link").length;c=void 0;var a={legend:[1,"<fieldset>","</fieldset>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],_default:g?[1,"X<div>","</div>"]:[0,"",""]};a.td=a.th=[3,"<table><tbody><tr>","</tr></tbody></table>"];a.option=a.optgroup=[1,'<select multiple="multiple">',"</select>"];a.thead=
a.tbody=a.colgroup=a.caption=a.tfoot=[1,"<table>","</table>"];a.polyline=a.ellipse=a.polygon=a.circle=a.text=a.line=a.path=a.rect=a.g=[1,'<svg xmlns="http://www.w3.org/2000/svg" version="1.1">',"</svg>"]},{}],86:[function(c,g,f){g.exports=function(a,b){b=b||{};return function(c){c=[].slice.call(arguments);window[a]||(window[a]=[]);!1===b.wrap?window[a].push.apply(window[a],c):window[a].push(c)}}},{}],87:[function(c,g,f){var a=c("to-function");g.exports=function(b,c){var d=[];c=a(c);for(var f=0;f<
b.length;++f)c(b[f],f)&&d.push(b[f]);return d}},{"to-function":73}],88:[function(c,g,f){function a(){return"https:"==location.protocol||"chrome-extension:"==location.protocol}g.exports=function(b){switch(arguments.length){case 0:return a();case 1:return a()?"https:"+b:"http:"+b}}},{}],80:[function(c,g,f){var a=c("./../lib/cookie.js");c=c("./trekkie.js").tag("TrekkieXtldFrame",'<iframe src="{{src}}">');c.prototype._initialize=c.prototype.initialize;c.prototype.initialize=function(){if(this._isShopifyDotCom()||
this._hasLongTermCookie())return this._initialize();this.load("TrekkieXtldFrame",{src:this._frameSource()},this._bind(this._iframeLoaded))};c.prototype._iframeLoaded=function(){var a=this._findTrekkieFrame();a?(window.addEventListener("message",this._bind(this._tokenReceived)),a.contentWindow.postMessage("getLongTermCookie",this._frameSource())):this._initialize()};c.prototype._tokenReceived=function(b){b&&0===this._frameSource().indexOf(b.origin)&&(a.write("_shopify_y",b.data,{permanent:!0}),this._initialize())};
c.prototype._hostname=function(){return window.location.hostname};c.prototype._frameSource=function(){return"https://cdn.shopify.com/s/javascripts/xtld.frame.html"};c.prototype._bind=function(a){var c=this;return function(){a.apply(c,Array.prototype.slice.call(arguments))}};c.prototype._isShopifyDotCom=function(){return null!==this._hostname().match(/(^|\.)shopify\.com$/)};c.prototype._hasLongTermCookie=function(){return null!==document.cookie.match("(^| )_shopify_y=([^;]+)")};c.prototype._findTrekkieFrame=
function(){for(var a=document.querySelectorAll("iframe"),c=0;c<a.length;c++)if(a[c].src===this._frameSource())return a[c].id="TrekkieXtldFrame",a[c]};g.exports=c},{"./../lib/cookie.js":107,"./trekkie.js":108}],107:[function(c,g,f){var a=c("cookie"),b=c("./utils.js"),e={read:function(b){return a(b)},writeForDomain:function(b,c,f,g){f={maxage:e._maxage(f),domain:g,path:"/"};a(b,c,f)},write:function(a,b,c){e.isEnabled()&&(c=c||{},e.writeForDomain(a,b,c.permanent,e.shopifyCookieDomain(window.location.hostname)),
e.writeForDomain(a,b,c.permanent,".myshopify.com"),e.writeForDomain(a,b,c.permanent,c.domain))},_maxage:function(a){return a?62208E6:18E5},shopifyCookieDomain:function(a){var c=a.indexOf("shopify");return-1!==c?b.startsWith(a,"shopify")?"."+a:a.slice(c-1):".shopify.com"},isEnabled:function(){return window.navigator.cookieEnabled}};f.read=e.read;f.write=e.write;f.shopifyCookieDomain=e.shopifyCookieDomain;f.isEnabled=e.isEnabled},{cookie:109,"./utils.js":110}],109:[function(c,g,f){function a(){var a;
try{a=document.cookie}catch(b){return"undefined"!==typeof console&&"function"===typeof console.error&&console.error(b.stack||b),{}}var c={};a=a.split(/ *; */);var d;if(""!=a[0])for(var f=0;f<a.length;++f)d=a[f].split("="),c[e(d[0])]=e(d[1]);return c}function b(a){try{return encodeURIComponent(a)}catch(b){d("error `encode(%o)` - %o",a,b)}}function e(a){try{return decodeURIComponent(a)}catch(b){d("error `decode(%o)` - %o",a,b)}}var d=c("debug")("cookie");g.exports=function(c,d,e){switch(arguments.length){case 3:case 2:var f;
f=e||{};var g=b(c)+"="+b(d);null==d&&(f.maxage=-1);f.maxage&&(f.expires=new Date(+new Date+f.maxage));f.path&&(g+="; path="+f.path);f.domain&&(g+="; domain="+f.domain);f.expires&&(g+="; expires="+f.expires.toUTCString());f.secure&&(g+="; secure");document.cookie=g;break;case 1:return a()[c];default:return a()}}},{debug:111}],111:[function(c,g,f){function a(){var a;try{a=f.storage.debug}catch(b){}return a}f=g.exports=c("./debug");f.log=function(){return"object"===typeof console&&console.log&&Function.prototype.apply.call(console.log,
...
{"./debug":112}],112:[function(c,g,f){f=g.exports=function(c){function d(){}function g(){var c=+new Date;g.diff=c-(b||c);g.prev=b;b=g.curr=c;null==g.useColors&&(g.useColors=f.useColors());null==g.color&&g.useColors&&(g.color=f.colors[a++%f.colors.length]);var d=Array.prototype.slice.call(arguments);d[0]=f.coerce(d[0]);"string"!==typeof d[0]&&(d=["%o"].concat(d));var e=0;d[0]=d[0].replace(/%([a-z%])/g,function(a,b){if("%%"===a)return a;e++;var c=f.formatters[b];"function"===typeof c&&(a=c.call(g,d[e]),
d.splice(e,1),e--);return a});"function"===typeof f.formatArgs&&(d=f.formatArgs.apply(g,d));(g.log||f.log||console.log.bind(console)).apply(g,d)}d.enabled=!1;g.enabled=!0;var k=f.enabled(c)?g:d;k.namespace=c;return k};f.coerce=function(a){return a instanceof Error?a.stack||a.message:a};f.disable=function(){f.enable("")};f.enable=function(a){f.save(a);for(var b=(a||"").split(/[\s,]+/),c=b.length,g=0;g<c;g++)b[g]&&(a=b[g].replace(/\*/g,".*?"),"-"===a[0]?f.skips.push(new RegExp("^"+a.substr(1)+"$")):
f.names.push(new RegExp("^"+a+"$")))};f.enabled=function(a){var b,c;b=0;for(c=f.skips.length;b<c;b++)if(f.skips[b].test(a))return!1;b=0;for(c=f.names.length;b<c;b++)if(f.names[b].test(a))return!0;return!1};f.humanize=c("ms");f.names=[];f.skips=[];f.formatters={};var a=0,b},{ms:113}],113:[function(c,g,f){function a(a){a=""+a;if(!(1E4<a.length)&&(a=/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(a))){var b=parseFloat(a[1]);
...
b)+" "+c:Math.ceil(a/b)+" "+c+"s"}g.exports=function(c,d){d=d||{};return"string"==typeof c?a(c):d.long?b(c,864E5,"day")||b(c,36E5,"hour")||b(c,6E4,"minute")||b(c,1E3,"second")||c+" ms":864E5<=c?Math.round(c/864E5)+"d":36E5<=c?Math.round(c/36E5)+"h":6E4<=c?Math.round(c/6E4)+"m":1E3<=c?Math.round(c/1E3)+"s":c+"ms"}},{}],110:[function(c,g,f){f.startsWith=function(a,b){return 0===a.indexOf(b)};f.endsWith=function(a,b){var c=a.length-b.length,d=a.indexOf(b);return-1!==d&&d===c}},{}],108:[function(c,g,
...
{id:a.userId(),eventType:"identify"});this.trekkie.emit("identify",a)};c.prototype.track=function(a){a=this._merge(a.properties(),{event:a.event(),eventType:"track"});this.trekkie.emit("track",a)};c.prototype.page=function(a){a=this._merge(a.properties(),{category:a.category(),name:a.name(),eventType:"page"});this.trekkie.emit("page",a)};c.prototype.alias=function(a){a={id:a.userId(),token:a.previousId(),eventType:"alias"};this.trekkie.emit("alias",a)};c.prototype._merge=function(a,c){var d=function(a,
b){for(var c in b)a[c]=b[c];return a},f=d({},a);return d(f,c)}},{"analytics.js-integration":85,"./../trekkie.js":114}],114:[function(c,g,f){function a(a,c){if(!a)throw"appName argument is required to initialize Trekkie.";this.appName=a;c=c?c:{};this.environment=c.environment||"production";delete c.environment;this.defaultAttributes=this._merge(c,{hasUniqCookie:b.hasUniqCookie()?1:0,hasVisitCookie:b.hasVisitCookie()?1:0,visitToken:b.visitToken(),uniqToken:b.uniqToken(),microSessionId:b.buildUniqToken(),
microSessionCount:0,firstSeen:b.firstSeen(),appName:a});this.request=e}var b=c("./lib/token.js"),e=c("./lib/request.js"),d=c("./lib/events.js");a.prototype.emit=function(a,b){this.defaultAttributes.microSessionCount+=1;var c=this._merge(this.defaultAttributes,this._sanitize(b)),c=this._merge(c,d.additionalParamsFromEvent(b.event));if("production"===this.environment)return this.request.load(this.appName,a,c);console.log("Logging trekkie "+a+" event to "+this.appName+" with:");console.log(c)};a.prototype._sanitize=
function(a){var b={},c;for(c in a)a[c]&&(b[c]=a[c]);return b};a.prototype._merge=function(a,b){var c=function(a,b){for(var c in b)a[c]=b[c];return a},d=c({},a);return c(d,b)};g.exports=a},{"./lib/token.js":115,"./lib/request.js":116,"./lib/events.js":117}],115:[function(c,g,f){var a=c("./cookie.js"),b=c("./store.js"),e={_uniqueId:{fetch:function(c,e){var f={permanent:c},g=a.read(e),f=b.read(e,f);return g||f},fetchOrSet:function(c){var f=c?"_y":"_s",g=c?"_shopify_y":"_shopify_s",f=(c&&void 0!==window._visit?
window._visit.multitrackToken():null)||e._uniqueId.fetch(c,f)||e._uniqueId.fetch(c,g)||e._uniqueId.build();c={permanent:c};a.write(g,f,c);b.write(g,f,c);return f},generateWeakUUID:function(){return"xxxxxxxx-xxxx-4xxx-xxxx".replace(/[x]/g,function(a){var b=16*Math.random()|0;return("x"===a?b:b&3|8).toString(16)}).toUpperCase()},generateStrongUUID:function(a){var b=0;return"xxxxxxxx-xxxx-4xxx-xxxx".replace(/[x]/g,function(c){var e=a[b]%16;b++;return("x"===c?e:e&3|8).toString(16)}).toUpperCase()},build:function(){if(a.isEnabled())try{var b=
window.crypto||window.msCrypto,c=new Uint16Array(19);b.getRandomValues(c);return e._uniqueId.generateStrongUUID(c)}catch(f){return e._uniqueId.generateWeakUUID()}else return"00000000-0000-0000-4000-000000000000"}},_firstSeen:{fetch:function(){var c=a.read("_shopify_fs"),e=b.read("_shopify_fs",{permanent:!0});return c||e},fetchOrSet:function(){var c=e._firstSeen.fetch()||(new Date).toISOString(),f={permanent:!0};a.write("_shopify_fs",c,f);b.write("_shopify_fs",c,f);return c}},hasShortTerm:function(){return!!a.read("_shopify_s")||
...
{"./cookie.js":107,"./store.js":118}],118:[function(c,g,f){var a={_storeType:function(a){a=a||{};return a.permanent?window.localStorage:window.sessionStorage},_isAvailable:function(a){try{a.setItem("t","t");var c=a.getItem("t");a.removeItem("t");return"t"===c}catch(d){return!1}},read:function(b,c){var d=a._storeType(c);return a._isAvailable(d)?d.getItem(b):null},write:function(b,c,d){d=a._storeType(d);return a._isAvailable(d)?d.setItem(b,c):null}};f.read=a.read;f.write=a.write},{}],116:[function(c,
g,f){var a=c("load-pixel")("https://v.shopify.com/:app/:type"),b=c("querystring").parse,e={load:function(b,c,f){return a(f,{app:b,type:c},e._error)},_error:function(c){if(c&&c.event===window.event){var e=c.source.src.split("?"),f=e[0].split(".com/")[1].split("/");c=f[0];var f=f[1],e=b(e[1]),g={};e.event&&(g.event=e.event);e.url&&(g.url=e.url);g.truncated=!0;return a(g,{app:c,type:f})}}};f.load=e.load},{"load-pixel":119,querystring:27}],119:[function(c,g,f){function a(a,b,c){return function(e){e=e||
window.event;var f=Error(b);f.event=e;f.source=c;a(f)}}var b=c("querystring").stringify,e=c("substitute");g.exports=function(c){return function(f,g,m){"function"==typeof g&&(m=g,g={});g=g||{};m=m||function(){};g=e(c,g);var l=new Image;l.onerror=a(m,"failed to load pixel",l);l.onload=function(){m()};(f=b(f))&&(f="?"+f);l.src=g+f;l.width=1;l.height=1;return l}}},{querystring:27,substitute:120}],120:[function(c,g,f){g.exports=function(b,c,d){if(!c)throw new TypeError("expected an object");d=d||/:(\w+)/g;
return b.replace(d,function(b,d){switch(a.call(c)){case "[object Object]":return null!=c[d]?c[d]:b;case "[object Array]":var f=c.shift();return null!=f?f:b}})};var a=Object.prototype.toString},{}],117:[function(c,g,f){var a={"Viewed Product":{resourceType:"product",pageType:"product"},"Added Product":{eventType:"add_to_cart",resourceType:"product",pageType:"cart"},"Removed Product":{eventType:"remove_from_cart",resourceType:"product",pageType:"cart"},"Viewed Cart":{pageType:"cart"},"Cleared Cart":{eventType:"clear_cart",
pageType:"cart"},"Viewed Product Category":{resourceType:"collection",pageType:"collection"},"Viewed Collections":{pageType:"collections"}};f.additionalParamsFromEvent=function(b){b=a[b];var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]=b[d]);return c}},{}],81:[function(c,g,f){f=c("analytics.js-integration");var a=c("component/cookie");c=g.exports=f("Multitrack").global("_visit").tag('<script src="//visitors.shopify.com/track.js?v=3">');c.prototype.initialize=function(){var a=this;this.load(function(){a._trackOptimizely();
a.ready()})};c.prototype.loaded=function(){return!!window._visit};c.prototype.track=function(a){var c=a.properties();window._visit.keyValue("event",a.event());for(var d in c)window._visit.keyValue(d,c[d])};c.prototype._trackOptimizely=function(){var b=a("optimizelyEndUserId"),c=a("optimizelyBuckets");b&&""!==b&&c&&""!==c&&"undefined"!==typeof _visit&&(_visit.keyValue("optimizelyEndUserId",b),_visit.keyValue("optimizelyBuckets",c))}},{"analytics.js-integration":85,"component/cookie":64}],82:[function(c,
g,f){c=c("analytics.js-integration");g=g.exports=c("Optimizely").global("optimizely");var a=4;g.prototype.initialize=function(){this.load(this.ready)};g.prototype.load=function(b){var c=this,d;c.loaded()?b():d=setInterval(function(){0<a&&(c.loaded()?(clearInterval(d),b()):(a--,0===a&&clearInterval(d)))},2E3)};g.prototype.loaded=function(){return!!window.optimizely&&!!window.optimizely.data};g.prototype.page=function(a){a=this._merge(a.properties(),{category:a.category(),name:a.name()});try{var c=
window.optimizely.data.experiments,d=window.optimizely.data.state.activeExperiments,f=window.optimizely.data.state.variationIdsMap,g=window.optimizely.data.state.variationNamesMap,m;for(m in d){var l=d[m];this.analytics.track("optimizely_experiment",this._merge(a,{experimentId:l,experimentName:c[l].name,variantId:f[l][0],variantName:g[l]}))}}catch(q){}};g.prototype._merge=function(a,c){var d=function(a,b){for(var c in b)a[c]=b[c];return a},f=d({},a);return d(f,c)}},{"analytics.js-integration":85}],
83:[function(c,g,f){f=c("analytics.js-integration");var a=c("./../lib/perf.js");c=g.exports=f("Performance").option("navigationTimingApiMeasurementsEnabled",!1).option("navigationTimingApiMeasurementsSampleRate",.5);c.prototype.initialize=function(){this.ready()};c.prototype.page=function(b){b=this._merge(b.properties(),{category:b.category(),name:b.name()});this.options.navigationTimingApiMeasurementsEnabled&&this.options.navigationTimingApiMeasurementsSampleRate>=Math.random()&&(b=this._merge(a.pagePerfomance(),
b),this.analytics.track("navigation_performance_metrics",b))};c.prototype._merge=function(a,c){var d=function(a,b){for(var c in b)a[c]=b[c];return a},f=d({},a);return d(f,c)}},{"analytics.js-integration":85,"./../lib/perf.js":121}],121:[function(c,g,f){var a="navigationStart unloadEventStart unloadEventEnd redirectStart redirectEnd fetchStart domainLookupStart domainLookupEnd connectStart connectEnd secureConnectionStart requestStart responseStart responseEnd domLoading domInteractive domContentLoadedEventStart domContentLoadedEventEnd domComplete loadEventStart loadEventEnd".split(" ");
f.perfAttrs=a;f.pagePerfomance=function(){var b={},c=function(){for(var c=0,d=a.length;c<d;c++)b["nt:"+a[c]]=0;b["nt:valid"]=!1};if(window.performance&&window.performance.timing&&!/MSIE 9.0|Firefox\/7.0|Firefox\/8.0/.test(window.navigator.userAgent))try{for(var d=0,f=a.length;d<f;d++)b["nt:"+a[d]]=window.performance.timing[a[d]];b["nt:valid"]=!0}catch(g){c()}else c();return b}},{}]},{},{1:"analytics"});
